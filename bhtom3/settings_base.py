...
GAIA_QUERY_CONNECT_TIMEOUT = float(secret.get('GAIA_QUERY_CONNECT_TIMEOUT', os.environ.get('GAIA_QUERY_CONNECT_TIMEOUT', '1.5')))
GAIA_QUERY_READ_TIMEOUT = float(secret.get('GAIA_QUERY_READ_TIMEOUT', os.environ.get('GAIA_QUERY_READ_TIMEOUT', '3')))
GAIA_TAP_SYNC_URLS = [
    url.strip()
    for url in str(
