...
from custom_code.views import (
    ...
    BhtomObservationProcessView,
    BhtomPallasAView,
    Bhtom2TargetListView,
    BhtomTargetCreateView,
    BhtomDataProductSaveView,
    BhtomDataProductUploadView,
    BhtomTargetDetailView,
    TargetDownloadPhotometryDataApiView,
    TargetDataProductsApiView,
    ...
    OrcidLoginView,
    ProposalListView,
    AAVSOMeasurementDetailView,
    RAPASMeasurementDetailView,
...
urlpatterns = [
    ...
    path('api/targets/<int:target_id>/products/', TargetDataProductsApiView.as_view(), name='target-data-products-api'),
    ...
    path('dataproducts/rapas/<int:pk>/', RAPASMeasurementDetailView.as_view(), name='rapas-measurement-detail'),
    ...
    path('observations/<int:pk>/process/', BhtomObservationProcessView.as_view(), name='observation-process-lco'),
